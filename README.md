...
|---|---|---|---|
| Каталог с фильтрами (цена, тип, локация, свободные даты) | ✅ | — | — |
| Карточка объекта: галерея, календарь занятости, бронирование | ✅ | — | — |
| CRUD объектов, загрузка фото, публикация | — | ✅ | — |
| Управление владельцами (email, пароль, TG chat_id, WA телефон) | — | ✅ | — |
| Общий календарь всех объектов + принудительное перекрытие дат | — | ✅ | — |
| Все заявки, смена статусов (Новый → В обработке → Подтверждён/Отказ) | — | ✅ | — |
...
src/app/owner/                # кабинет владельца: объекты, календарь, заявки
